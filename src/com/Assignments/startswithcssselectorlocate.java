...
public class startswithcssselectorlocate {
	...
	public static void main(String[] args) {
		...
		WebElement usernamefield=driver.findElement(By.cssSelector("input[type^='te']"));
		usernamefield.sendKeys("Christopher");

		WebElement Passwordfield=driver.findElement(By.cssSelector("input[placeholder^='Pass']"));
