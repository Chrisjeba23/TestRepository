...
public class A3_AutomobilePlatinum {
	...
	public static void main(String[] args) throws AWTException, InterruptedException {
		...
		WebElement Platinumplan=driver.findElement(By.xpath("//*[@id=\"priceTable\"]/thead/tr/th[4]"));
		String PP= Platinumplan.getText();
		System.out.println("The txt of the Platinum plan is:" +PP);

		if(PP.equals(Platinumplan.getText()))
		{
			System.out.println("Pass--The plan is Platinum");
		}

		else
		{
			System.out.println("Fail--The plan is not Platinum");
		}

		WebElement Platinumpriceperyear=driver.findElement(By.xpath("//*[@id=\"selectplatinum_price\"]"));
		String PPY=Platinumpriceperyear.getText();
		System.out.println("The Text of the Price per year is:" +PPY);

		if(PPY.equals(Platinumpriceperyear.getText()))
		{
			System.out.println("Pass-The Price per year of Platinum is $1392");
		}
		else {
			System.out.println("Fail-The price per year of Platinum is not $1392");
		}

		WebElement PlatinumOnlineclaim=driver.findElement(By.xpath("//*[@id=\"priceTable\"]/tbody/tr[2]/td[4]"));
		String POC= PlatinumOnlineclaim.getText();
		System.out.println("The txt of the Online claim is:" +POC);

		if(POC.equals(PlatinumOnlineclaim.getText()))
		{
		...
		WebElement PlatinumClaimdiscount=driver.findElement(By.xpath("//*[@id=\"priceTable\"]/tbody/tr[3]/td[4]"));
		String PCD= PlatinumClaimdiscount.getText();
		System.out.println("The txt of the Online claim is:" +PCD);

		if(PCD.equals(PlatinumClaimdiscount.getText()))
		{
			System.out.println("Pass-Claim Discount is 5");
		}

		else
		{
			System.out.println("Fail-Claim Discount is not 5");
		}

		WebElement PlatinumWorldwidecover=driver.findElement(By.xpath("//*[@id=\"priceTable\"]/tbody/tr[4]/td[4]"));
		String GWW= PlatinumWorldwidecover.getText();
		System.out.println("The txt of the Online claim is:" +GWW);

		if(GWW.equals(PlatinumWorldwidecover.getText()))
		{
		...
		WebElement Platinumplanbutton=  driver.findElement(By.xpath("//*[@id=\"priceTable\"]/tfoot/tr/th[2]/label[3]/span"));
		//Select Gold Plan button

		if(!Platinumplanbutton.isSelected())
		{
			Platinumplanbutton.click();
			System.out.println("Pass-The Platinum plan button is selected");
		}
		else
		{
			System.out.println("Fail-The Platinum plan button is not selected");
		}
